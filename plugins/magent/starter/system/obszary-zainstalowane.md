# Obszary zainstalowane i skonfigurowane

> **Katalog zdolności MarketingAgent** — spis obszarów, które klient realnie dodał (plugin) i skonfigurował (komenda startowa danego obszaru).
...
## Rdzeń
- **magent** — @copywriter, nauka firmy, operator marketingu. Zawsze obecny (to on czyta ten plik).
