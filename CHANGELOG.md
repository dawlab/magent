# Co nowego w MarketingAgent

Najnowsze na górze. Po aktualizacji agent pokaże Ci te zmiany przy `/start`.

## 0.2.0

- **Nowy obszar: Social media.** Składa kompletny post — tekst, grafikę w kolorystyce Twojej marki i opis publikacji — i publikuje go przez zernio po Twojej akceptacji.
- **Zalecany zestaw narzędzi.** Komenda `/narzedzia` proponuje i konfiguruje jedno narzędzie naraz (analityka strony, wizytówka, email, publikacja) — zawsze zaczynając od bezpłatnych.
...
- Pierwsza wersja: rdzeń (agent, Twój styl wypowiedzi, nauka firmy, planowanie) oraz obszary Treści, Opinie, Sprzedaż, Polecenia i Reklama.
